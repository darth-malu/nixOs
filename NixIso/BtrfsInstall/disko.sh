...
#cp /run/media/nixos/Ventoy/BtrfsInstall/* /mnt/etc/nixos/

#sudo nixos-install --flake /run/media/nixos/Ventoy/nixOs#carthage

#sudo nixos-install --option extra-experimental-features "nix-command flakes"
