...

{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      "$rofi_open_windows" =  "rofi -show window -theme-str 'window {height: 620px; width : 800px;}' -theme-str 'element {background-image: linear-gradient(white/5%, white/20%);border-color: lightblue /15%;}'" ;
