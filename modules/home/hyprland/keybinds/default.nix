...

{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      "$file_browser_rofi" =
        "rofi -show filebrowser -sidebar-mode -theme-str 'window {height: 820px; width : 1000px;}' -theme-str 'element-icon {size: calc(((100% - 8em) / 7 ));horizontal-align: 0.5;vertical-align: 0.5;}'";
      "$rofi_open_windows" =
        "rofi -show window -theme-str 'window {width : 800px;}' -theme-str 'listview {lines: 8; dynamic: true;}' -theme-str 'element {background-image: linear-gradient(white/5%, white/10%);border-color: lightblue /15%;}'";
      ...
      "$clip_rofi" =
        "cliphist list | rofi -dmenu -theme-str 'window {width : 650px;}' -p '' | cliphist decode | wl-copy";
      ...
      bind =
        ...
        ++ (
          ...
          builtins.concatLists (
            # TODO: learn more about builtins
            builtins.genList (
              i:
              let
                ws = i + 1;
