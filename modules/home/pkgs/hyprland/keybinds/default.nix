...

{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      "$file_browser_rofi" =
        "rofi -show filebrowser -filebrowser-command 'xdg-open' -filebrowser-directory '/home/malu' -theme '/home/malu/Shibuya/modules/home/pkgs/hyprland/keybinds/rofi-themes/fileBrowser.rasi'";
      "$rofi_open_windows" =
