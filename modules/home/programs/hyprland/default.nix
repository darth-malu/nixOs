{
  ...
  config = {
    wayland.windowManager.hyprland = {
      ...
      portalPackage = null;
      # systemd = {
      #   # ENBALE -- turn on hyprland-session.target
      #   enable = true; # import to systemd DISPLAY WAYLAND_DISPLAY XDG_CURRENT_DESKTOP HYPRLAND_INSTANCE_SIGNATURE #WARN: last change true -> false
