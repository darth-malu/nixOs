...

{
  ...
  programs.mpv = {
    ...
    config = {
      ...
      profile = if osConfig.networking.hostName == "carthage" then "high-quality" else "fast";
      ...
      sub-font-size = 29; # 55::The unit is the size in scaled pixels at a window height of 720. The actual pixel size is scaled with the window height: if the window height is larger or smaller than 720, the actual size of the text increases or decreases as well.
      # sub-bold = true;
