...
https://github.com/JakeStanger/mpd-discord-rpc#configuration.
...
smartskip: https://github.com/Eisa01/mpv-scripts
*** script opts
built-in scripts exist see Man:mpv
**** start
#+begin_src nix :tangle default.nix
scriptOpts = {
#+end_src
**** [[file:scriptOpts/uosc.nix][uosc]]
#+begin_src nix :tangle default.nix
# uosc = import ./scripts/uosc.nix;
uosc = import ./scriptOpts/uosc.nix;
#+end_src
**** [[file:scriptOpts/modernx-zydezu.nix][modernX-zydezu]]
#+begin_src nix :tangle default.nix
...
https://github.com/Eisa01/mpv-scripts?tab=readme-ov-file#default-keybinds
...
source: [[https://github.com/tomasklaen/uosc?tab=readme-ov-file#adding-items-to-menu][uosc - adding items to menu (github)]]

**** default keybindings uosc
...
Sub-configuration options for specific profiles written to =$XDG_CONFIG_HOME/mpv/mpv.conf=
...
source:[[https://mpv.io/manual/master/#video-output-drivers-vo]]

wayland vo:
|----------+---------------------------------------------------------------------------------------------------------------|
| gpu      | General purpose, customizable, GPU-accelerated video output driver                                            |
| gpu-next | experimental video renderer baced on /libplacebo/ - faster and higher quality but some features might misbehave |
| vaapi    | no reason to use unless compatibility - low quality issues with OSD recommend (--vo=gpu + --hwdec=vaapi)      |
|----------+---------------------------------------------------------------------------------------------------------------|

see gpu next:[[https://github.com/mpv-player/mpv/wiki/GPU-Next-vs-GPU]]
** default profiles
...
display-resample-desync:
         the previous mode, but no A/V compensation.
...
* plugin-opts scriptOpts/
** uosc
https://github.com/tomasklaen/uosc/blob/HEAD/src/uosc.conf
*** config
**** starter
...
**** font
font_scale - affects chapters/playlist font scale
#NOTE: not sure scale is working
#+begin_src nix :tangle scriptOpts/uosc.nix
...
**** video / audio / subtitle / playlist types
...
source:[[github:po5/memo?tab=readme-ov-file#custom-keybinds][Memo (github)]]
