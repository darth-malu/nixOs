...
gap_incrementer () {
    ...
    #config_gap_out=$(grep 'gaps_out' ~/Shibuya/modules/home/hyprland-ecos/hyprland/ui.nix | tr -cd "[:digit:]")
    #config_gap_in=$(grep 'gaps_in' ~/Shibuya/modules/home/hyprland-ecos/hyprland/ui.nix | tr -cd "[:digit:]")
    config_gap_out=$(grep 'gaps_out' "$HOME/Shibuya/modules/hyprland-carthageModules/home/hyprland/hyprland/ui.nix" | tr -cd "[:digit:]")
    config_gap_in=$(grep 'gaps_in' "$HOME/Shibuya/modules/hyprland-carthageModules/home/hyprland/hyprland/ui.nix" | tr -cd "[:digit:]")
    ...
    case $1 in
        ...
        "custom")
            ...
            dunstify -t 1000 -a "changegaps" -u low -i icons/volume-off-solid -h string:x-dunst-stack-tag:$msgTag "Gaps out reset to config defaults : $config_gap_out" 
            ;;
        *)
